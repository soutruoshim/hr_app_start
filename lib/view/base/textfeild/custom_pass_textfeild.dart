...
class CustomPasswordTextField extends StatefulWidget {
  ...
  CustomPasswordTextField({required this.controller, required this.hintTxt, required this.focusNode, required this.nextNode, required this.textInputAction, this.border = false, required this.prefixIconImage});
